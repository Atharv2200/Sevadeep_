...
import { BookOpen, Smile, Sparkles, Users } from 'lucide-react'

const FOCUS_AREAS = ['Community Service', 'Education Support', 'Healthcare Access', 'Environmental Care']
    ...
    <section id="about" className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="grid grid-cols-2 gap-4">
